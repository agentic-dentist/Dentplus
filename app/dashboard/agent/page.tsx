export default function AgentPage() {
  return (
    <>
      ...
      <div className="page-sub">Conversation logs and agent activity</div>
      <div className="coming">
        <div className="coming-icon">🤖</div>
        <div className="coming-title">Coming soon</div>
        <div className="coming-sub">View all patient conversations, agent decisions, and booking history in one place.</div>
      </div>
    </>
  )
}
