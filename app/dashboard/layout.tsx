    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .nav-label {
          ...
          text-transform: uppercase; color: rgba(148,163,184,0.25);
        ...
        .nav-item.active {
          background: rgba(14,165,233,0.1); color: #0EA5E9; font-weight: 500;
        }
        .nav-item.active::before {
          content: ''; position: absolute; left: 0; top: 50%;
          transform: translateY(-50%); width: 2px; height: 55%;
        ...
        .widget-btn {
          ...
          border-radius: 8px; color: #0EA5E9;
        ...
        .widget-dot {
          ...
          background: #0EA5E9; box-shadow: 0 0 6px rgba(14,165,233,0.8);
        }
      ...
      <div className="layout">
        <aside className="sidebar">
          ...
          <button className="widget-btn" onClick={() => window.open(`/widget/${CLINIC_ID}`, '_blank')}>
