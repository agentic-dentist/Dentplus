export default function ReportsPage() {
  return (
    <>
      ...
      <div className="page-sub">Practice analytics and insights</div>
      <div className="coming">
        <div className="coming-icon">📊</div>
        <div className="coming-title">Coming soon</div>
        <div className="coming-sub">Revenue reports, appointment trends, AI performance metrics, and patient recall analytics.</div>
      </div>
    </>
  )
}
