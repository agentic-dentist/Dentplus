...
export default function RegisterPage({
  ...
  if (success) {
    return (
      <div style={{ minHeight: '100vh', background: '#F8FAFC', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem', fontFamily: "'Inter', sans-serif" }}>
        <div style={{ background: 'white', borderRadius: 20, border: '1px solid #E2E8F0', padding: 40, maxWidth: 400, width: '100%', textAlign: 'center', boxShadow: '0 4px 24px rgba(0,0,0,0.06)' }}>
          ...
          <button onClick={() => router.push('/')}
            style={{ background: '#4F46E5', color: 'white', border: 'none', borderRadius: 10, padding: '10px 24px', fontSize: 14, fontFamily: "'Inter', sans-serif", cursor: 'pointer' }}>
            Go to sign in
          </button>
        </div>
      </div>
  ...
  return (
    <>
      <style>{`@import url('https://fonts.googleapis.com/css2?family=Syne:wght@600;700&family=Inter:wght@400;500;600&display=swap');`}</style>
      <div style={{ minHeight: '100vh', background: '#F8FAFC', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '2rem', fontFamily: "'Inter', sans-serif" }}>
        <div style={{ background: 'white', borderRadius: 20, border: '1px solid #E2E8F0', padding: 40, width: '100%', maxWidth: 400, boxShadow: '0 4px 24px rgba(0,0,0,0.06)' }}>
          ...
          <div style={{ marginBottom: 14 }}>
            ...
            <input type="text" placeholder="Marie Tremblay" value={fullName} onChange={e => setFullName(e.target.value)}
              style={{ width: '100%', padding: '10px 14px', border: '1.5px solid #E2E8F0', borderRadius: 8, fontSize: 14, fontFamily: "'Inter', sans-serif", outline: 'none', boxSizing: 'border-box' }} />
          </div>
          ...
          <p style={{ textAlign: 'center', fontSize: 13, color: '#94A3B8', marginTop: 16, marginBottom: 0 }}>
            ...
            <button onClick={() => router.push('/')}
              style={{ background: 'none', border: 'none', color: '#4F46E5', cursor: 'pointer', fontSize: 13, fontFamily: "'Inter', sans-serif" }}>
              Sign in
            </button>
          </p>
        </div>
